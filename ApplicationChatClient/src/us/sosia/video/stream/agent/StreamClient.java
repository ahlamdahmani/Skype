...
public class StreamClient {
	...
	public StreamClient(String addr) {
		...
		clientAgent.connect(new InetSocketAddress(addr, 20000));
	...
	public static void main(String[] args) {
		...
		StreamClientAgent clientAgent = new StreamClientAgent(
				new StreamFrameListenerIMPL(), dimension);
		clientAgent.connect(new InetSocketAddress("192.168.1.17", 20000));
	}

	public static SingleVideoDisplayWindow getDisplaywindow() {
